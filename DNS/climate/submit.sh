...
srun -n 1024 ./climate -d 3 -p 16 8 8 -i ./input-pr-dns/in-entrainment3dd_caseS22 -o $PSCRATCH/output_caseH2_256 |& tee srun.log
##srun -n 1024 ./climate -d 3 -p 16 8 8 -i ./input-pr-dns/in-entrainment3dd_caseS22 -o $PSCRATCH/output_caseL2_256_FA |& tee srun.log
